...
<head>
  ...
  .order-card {
    background: #0f0f0f;
    border: 2px solid #C49C74;
    box-shadow: 0 0 15px #C49C7480;
    border-radius: 13px;
    padding: 1.2rem;
  ...
  .item-box {
    background: #121212;
    border-left: 5px solid #C49C74;
    padding: 0.6rem 1rem;
    margin-bottom: 0.6rem;
    border-radius: 6px;
    box-shadow: 0 0 6px #C49C7466;
    color: #f0e9dc;
  }
  ...
  .table thead th {
    ...
    color: #C49C74;
    border-bottom: 1px solid #C49C74;
  }
