...
@section('content')
    <div class='row'>
        ...
        <div class='col-lg-6 col-md-6 col-sm-12' style='text-align: right;'>
            {{-- <a href='{{ url('trash-users') }}'><button class='btn btn-danger'><i class='fas fa-trash'></i> Trash <span class='text-warning'>{{ App\Models\Users::where('isTrash', '1')->count() }}</span></button></a> --}}
